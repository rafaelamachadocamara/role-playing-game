...
function updateHealthBar() {
    if (fighting) {
        ...
        const percentHealth = (monsterHealth / monster.health) * 100;
        healthBarFill.style.width = `${percentHealth}%`;


        if (percentHealth > 50) {
            healthBarFill.style.backgroundColor = '#ff3333';
